...
<body>
        ...
        <nav class="navbar navbar-expand-lg bg-primary-subtle py-2 py-lg-10">
            <div class="custom-container d-flex align-items-center justify-content-between">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mx-auto mb-2 gap-xl-7 gap-8 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link fs-4 px-6 fw-bold text-dark link-primary"
                                href="{{ route('inicio.index') }}">Inicio</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link fs-4 px-6 fw-bold text-dark link-primary"
                                href="{{ route('quienessomos.index') }}">Quienes somos</a>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link fs-4 px-6 fw-bold text-dark link-primary d-flex gap-2"
                                href="{{ route('historia.index') }}">Historia
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link fs-4 px-6 fw-bold text-dark link-primary"
                        ...
                        <li class="nav-item">
                            <a class="nav-link fs-4 px-6 fw-bold text-dark link-primary"
                                href="{{ route('artistas.create') }}">Inscripciones</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link fs-4 px-6 fw-bold text-dark link-primary"
                                href="{{ route('artistas.activos') }}">Artistas</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link fs-4 px-6 fw-bold text-dark link-primary"
                                href="{{ route('donaciones.index') }}">Donaciones</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link fs-4 px-6 fw-bold text-dark link-primary"
                                href="{{ route('contantos.indexcontactos') }}">Contacto</a>
                        </li>
                    </ul>
                    <div>
                        <a href="{{ route('donaciones.index') }}" class="btn btn-primary py-8 px-9">Admin</a>
  ...
  <!-- ------------------------------------- -->
                ...
                <li class="mb-1">
                    <a href="{{ route('contantos.indexcontactos') }}"
                        class="px-0 fs-4 d-block w-100 py-2 text-dark link-primary">
                        Contacto
                    </a>
                </li>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body pt-0">
                    <iframe width="100%" height="500"
                        src="https://www.youtube.com/embed/wJkl3P5HnZw?si=n4EJ7JztrSZ3gWsc"
