                ...
                <div class="content-section">
                    ...
                    <form>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="horarioextras" class="form-control"
                                value="{{ $contactos->horarioextras }}" name="horarioextras">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="url" id="urlfacebook" class="form-control"
                                value="{{ $contactos->urlfacebook }}" name="urlfacebook">
                        </div>

                        <div class="form-group">
                            <label for="urlx">x:</label>
                            <input type="url" id="urlx" class="form-control" name="urlx"
                                value="{{ $contactos->urlx }}">
                        </div>


                        <div class="form-group">
                            <label for="urlinstagram">Instagram:</label>
                            <input type="url" id="urlinstagram" class="form-control" name="urlinstagram"
                                value="{{ $contactos->urlinstagram }}">
                        </div>
