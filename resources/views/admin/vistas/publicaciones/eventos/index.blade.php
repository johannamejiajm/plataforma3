...
@section('content')
      ...
      <div class="modal fade" id="modalEditarEvento" tabindex="-1" aria-labelledby="modalEditarLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
          <div class="modal-content p-4">
...
@endsection
@section('scripts')
      @includeIf('admin.vistas.publicaciones.eventos.script')
@endsection
