        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <div class="navbar-collapse justify-content-end px-0" id="navbarNav">
                <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-end">
                    <a href="#" target="_blank" class="btn btn-primary">Check Pro Template</a>
                    <li class="nav-item dropdown">
                        ...
                        <div class="card-body">
                            <div class="d-md-flex align-items-center">
                                <div>
                                    ...
                                    <p class="card-subtitle">Gestionar Artistas</p>
                                </div>
                            </div>
                                    ...
                                    <tbody>
                                        @foreach ($artistas as $artista)
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($artista->imagen)
                                                        <img src="{{ asset('storage/' . $artista->imagen) }}"
                                                            alt="Foto de {{ $artista->nombre_artista }}" width="60" height="60"
                                                ...
                                                <td>
                                                    <form method="POST"
                                                        action="{{ route('artistas.cambiarEstado', $artista->artista_id) }}"
                                                        class="d-inline">
                                                        @csrf
                                                        <button type="submit"
                                                            class="btn btn-sm {{ $artista->estado_artista == '1' ? 'btn-warning' : 'btn-success' }}">
    ...
    <table class="table table-striped table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <form method="POST" action="{{ route('artistas.cambiarEstado', $artista->artista_id) }}"
                        class="d-inline">
                        @csrf
                        <button type="submit"
                            class="btn btn-sm {{ $artista->estado_artista == '1' ? 'btn-warning' : 'btn-success' }}">
